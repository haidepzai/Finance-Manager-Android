...
import de.hdmstuttgart.financemanager.Activity.IntroActivity;
...
public class SearchTest {
    ...
    public void searchTest() {
        ...
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.inputPurpose),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText.perform(replaceText("REWE"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.inputAmount),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("37.80"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.searchPurpose),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.widget.LinearLayout")),
                                        0),
                                0),
                        isDisplayed()));
        appCompatEditText3.perform(replaceText("rewe"), closeSoftKeyboard());

        ViewInteraction appCompatButton3 = onView(
                allOf(withId(R.id.searchButton), withText("Suchen"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.fragment_container),
                                        0),
        ...
        ViewInteraction recyclerView = onView(
                allOf(withId(R.id.recyclerViewSearch),
                        childAtPosition(
        ...
        ViewInteraction editText = onView(
                allOf(withId(R.id.detailPurpose), withText("REWE"),
                        childAtPosition(
                                childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        editText.check(matches(withText("REWE")));
    }
