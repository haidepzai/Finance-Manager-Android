...
public class BarChartView extends View {
    ...
    private void init(@Nullable AttributeSet set) {
        ...
        maxAmount = StatisticFragment.totalAmount;
        ...
        Log.d("maxAmount", String.valueOf(maxAmount));
    ...
    private void drawBar(Canvas canvas) {
        ...
        mBar1.top = 1500 - ((grocery / maxAmount) * 1000); //Höhe (500 = 100%; 1500 = 0%; 1000 = 50%)
        mBar1.right = 150; //dicke (+90 zu left)
        mBar1.bottom = 1500; //Start
        Log.d("Groceryyy", String.valueOf(grocery));
        Log.d("Maxxxxxxxxxx", String.valueOf(maxAmount));
        ...
        mBar2.top = 1500 - ((food / maxAmount) * 1000); //Höhe (500 = 100%; 1500 = 0%; 1000 = 50%)
        ...
        mBar3.top = 1500 - ((education / maxAmount) * 1000); //Höhe (500 = 100%; 1500 = 0%; 1000 = 50%)
        ...
        mBar4.top = 1500 - ((leisure / maxAmount) * 1000); //Höhe (500 = 100%; 1500 = 0%; 1000 = 50%)
        ...
        mBar5.top = 1500 - ((fee / maxAmount) * 1000); //Höhe (500 = 100%; 1500 = 0%; 1000 = 50%)
        ...
        mBar6.top = 1500 - ((misc / maxAmount) * 1000); //Höhe (500 = 100%; 1500 = 0%; 1000 = 50%)
